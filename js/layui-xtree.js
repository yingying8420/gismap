...
layuiXtree.prototype.dataBind = function (d) {
    ...
    if (d.length > 0) {
        for (var i=0;i< d.length;i++) {
            ...
            _this._domStr += '<input type="checkbox" class="layui-xtree-checkbox" ' + xtree_isend + xtree_ischecked + xtree_isdisabled + ' value="' + d[i].id + '" title="' + d[i].areaName + '" lay-skin="primary" lay-filter="xtreeck' + _this._containerid + '">';
